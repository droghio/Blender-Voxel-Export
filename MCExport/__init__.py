...
from MCExport.mcedit import schematic
...
class VoxelizeOutput(bpy.types.Operator):
    ...
    def execute(self, context):        # execute() is called by blender when running the operator.
        ...
        creeper = mcedit.schematic.MCSchematic(shape=(sizes[0],sizes[1],sizes[2]))
        #W, H, L in declaration.
        #H, W, L in assignment. (I think.)

        #Layer 1
        creeper._Blocks[0][0][0] = 1
        ...
        if (len(selectedfaces) > 0):
            ...
            #Determine where there are voxels.
                ...
                for f in selectedfaces:
                    ...
                    creeper._Blocks[math.floor(v[0])][math.floor(v[1])][math.floor(v[2])]
                    try:
