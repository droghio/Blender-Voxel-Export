...
from MCExport.mcedit.box import BoundingBox
from . import infiniteworld
from MCExport.mcedit.level import MCLevel, EntityLevel
from MCExport.mcedit.materials import alphaMaterials, MCMaterials, namedMaterials
from MCExport.mcedit.mclevelbase import exhaust
from . import nbt
...
class INVEditChest(MCSchematic):
    ...
    Data = array([[[0]]], 'uint8')
    Entities = None; #John's quick fix. nbt.TAG_List()
    Materials = alphaMaterials
